...
in
{
  ...
  "inlineEdit.modifiedChangedTextBackground" = yellow;
  "inlineEdit.modifiedChangedLineBackground" = yellow;
  "inlineEdit.modifiedBorder" = yellow;
  "inlineEdit.modifiedBackground" = yellow;
  ...
  "diffEditor.insertedLineBackground" = green;
