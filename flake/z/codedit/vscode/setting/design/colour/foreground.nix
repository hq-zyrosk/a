let
  c9 = _.rgba 1.00 1.00 1.00 1; # "#3C3C3CFF";
  c5 = _.rgba 0.50 0.50 0.50 1;
  c1 = _.rgba 0.25 0.25 0.25 1;
  _ = import ./_.nix;
in
{
  ...
  "input.foreground" = c9;
  "gitDecoration.stageDeletedResourceForeground" = c9;
  ...
  "editorLineNumber.dimmedForeground" = c5;
  ...
  "gitDecoration.addedResourceForeground" = c5;
  "gitDecoration.renamedResourceForeground" = c5;
  "gitDecoration.deletedResourceForeground" = c5;
  "gitDecoration.submoduleResourceForeground" = c5;
  ...
  "git.blame.editorDecorationForeground" = c5;
  ...
  "editorLightBulbAi.foreground" = c5;
  ...
  "tab.unfocusedActiveModifiedBorder" = c5;
  "tab.unfocusedInactiveModifiedBorder" = c5;
  "tab.inactiveModifiedBorder" = c5;
  "charts.lines" = c5;
